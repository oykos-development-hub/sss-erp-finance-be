...
func NewFixedDepositItemHandler(app *celeritas.Celeritas, fixeddeposititemService services.FixedDepositItemService, errorLogService services.ErrorLogService) FixedDepositItemHandler {
