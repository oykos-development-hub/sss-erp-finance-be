...
type FilledFinancialBudgetService interface {
	...
	UpdateActualFilledFinancialBudget(ctx context.Context, id int, amount decimal.Decimal, Type int, requestID int) (*dto.FilledFinancialBudgetResponseDTO, error)
...
type SpendingDynamicService interface {
	...
	GetActual(budgetID, unitID, accountID, Type int) (decimal.Decimal, error)
