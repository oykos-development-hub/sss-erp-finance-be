...
('Doprinos za PIO', 2, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost', 2, 0, 1175, NOW(), NOW()),
('Doprinos za PIO (zaposleni)', 2, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost (zaposleni)', 2, 0, 1175, NOW(), NOW()),
('Doprinos za PIO (poslodavac)', 2, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost (poslodavac)', 2, 0, 1175, NOW(), NOW()),
('Doprinos za Fond rada', 2, 0, 1175, NOW(), NOW()),
--knjizenje ugovora
...
('Doprinos za PIO', 2, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost', 2, 0, 1175, NOW(), NOW()),
('Doprinos za PIO (zaposleni)', 3, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost (zaposleni)', 3, 0, 1175, NOW(), NOW()),
('Doprinos za PIO (poslodavac)', 3, 0, 1175, NOW(), NOW()),
('Doprinos za nezaposlenost (poslodavac)', 3, 0, 1175, NOW(), NOW()),
('Doprinos za Fond rada', 3, 0, 1175, NOW(), NOW()),
--knjizenje zarada
...
--knjizenje povracaja
('Prinudna naplata', 7, 1175, 0, NOW(), NOW()),
('Dobavljač', 7, 0, 1175, NOW(), NOW());
